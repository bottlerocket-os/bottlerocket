...
%global user_data_provider ec2-identity-doc
...
%package -n %{_cross_os}ec2-identity-doc-user-data-client
Summary: EC2 identity doc user data client
%description -n %{_cross_os}ec2-identity-doc-user-data-client
%{summary}.

# Symlinks the binary to the appropriate .d directory as 30-
%package -n %{_cross_os}ec2-identity-doc-user-data-provider
Summary: EC2 identity doc user data provider config
%description -n %{_cross_os}ec2-identity-doc-user-data-provider
%{summary}.
...
%files -n %{_cross_os}ec2-identity-doc-user-data-client
%{_cross_libexecdir}/early-boot-config/bin/%{user_data_provider}-provider

%files -n %{_cross_os}ec2-identity-doc-user-data-provider
