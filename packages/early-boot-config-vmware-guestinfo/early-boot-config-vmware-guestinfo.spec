...
%global user_data_provider vmware-guestinfo

Name: %{_cross_os}early-boot-confi-%{user_data_provider}
Version: 0.0
Release: 0%{?dist}
...
%package -n %{_cross_os}vmware-guestinfo-user-data-client
Summary: VMWare guestinfo user data client
%description -n %{_cross_os}vmware-guestinfo-user-data-client
%{summary}.

# Symlinks the binary to the appropriate .d directory as 40-
%package -n %{_cross_os}vmware-guestinfo-user-data-provider
Summary: VMWare guestinfo user data provider config
%description -n %{_cross_os}vmware-guestinfo-user-data-provider
%{summary}.
...
%files -n %{_cross_os}vmware-guestinfo-user-data-client
%{_cross_libexecdir}/early-boot-config/bin/%{user_data_provider}-provider

%files -n %{_cross_os}vmware-guestinfo-user-data-provider
