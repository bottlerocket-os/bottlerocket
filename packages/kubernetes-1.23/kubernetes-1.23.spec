...
Source11: dockershim-symlink.conf
...
install -p -m 0644 %{S:11} %{buildroot}%{_cross_unitdir}/kubelet.service.d/dockershim-symlink.conf
...
%{_cross_libdir}/systemd/system/kubelet.service.d/dockershim-symlink.conf
