...
URL: https://%{goimport}
Source0: https://eks-d-postsubmit-artifacts.s3.us-west-2.amazonaws.com/kubernetes-1-22/releases/2/artifacts/kubernetes/v%{gover}/kubernetes-src.tar.gz
...
%package -n %{_cross_os}kubelet-1.22
...
%files -n %{_cross_os}kubelet-1.22
