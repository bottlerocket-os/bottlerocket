...
fn main() {
    ...
    let checker: Box<dyn Checker> = match cmd_name {
        ...
        "br03020600" => Box::new(BR03020600Checker {}),
        "br03020700" => Box::new(BR03020700Checker {}),
        "br03030100" => Box::new(BR03030100Checker {}),
        "br03040101" => Box::new(BR03040101Checker {}),
        "br03040102" => Box::new(BR03040102Checker {}),
        ...
        "br03040202" => Box::new(BR03040202Checker {}),
